	...
	<div class="container">
		<div class="row justify-content-center mb-5">
			<div class="col-md-7 heading-section text-center ftco-animate">
				...
				<br>
				<h2 class="mb-4">Cari tempat kopi terbaikmu</h2>
				<div class="row">
					<div class="col-md-12">
						<form action="<?=base_url()?>cari-cafe" method="get">
									...
									<select name="lokasi" id="" class="form-control bg-white">
										<?php
											if ($provinsi['count'])
											{
												...
												{
													?>
													<option class="text-dark" value="<?=$p->kode?>"><?=$p->nama?></option>
													<?php
												}
											}
										?>
							...
							<button class="btn btn-primary btn-outline-primary p-3 px-xl-4 py-xl-3" type="submit">Cari Sekarang</button>
						</form>
					</div>
				</div>
			</div>
