                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="about-author d-flex">
                            <div class="bio align-self-md-center mr-5">
								...
								{
									?>
                                <img src="<?=base_url()?>assets/images/user.jpg" alt="Image placeholder"
                                    style="width: 200px; height: 200px; border-radius: 200px;" class="img-fluid mb-4">
								...
								{
									?>
                                <img src="<?=base_url()?>ava/<?=$user->ava?>" alt="Image placeholder"
                                    style="width: 200px; height: 200px; border-radius: 200px;" class="img-fluid mb-4">
                            ...
                            <div class="desc align-self-md-center">
                                ...
                                <p><i class="material-icons">room</i>
									...
									$pengikut = crud_selwhere("follower",NULL,"mengikuti = '$user->username' ")['count'];
										if ($user->provinsi == "")
										{
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="block-18 text-center" style="cursor: pointer;" data-toggle="modal"
                                    data-target="#pengikut">
                                    <div class="text">
                            ...
                            <div class="col-md-3">
                                <?php
									...
									$likeCafe = crud_selwhere("like_cafe",NULL,"user = '$user1'");
                            ...
                            <div class="col-md-4">
                                <button style="margin-bottom: 30px;" class="btn btn-primary" data-toggle="modal"
                                    data-target="#editPhoto"><i class="material-icons">edit</i> Edit Photo
                                    Profile</button>

                                <button class="btn btn-primary" data-toggle="modal" data-target="#editProfile"><i
                                        class="material-icons">edit</i> Edit Profile</button>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="sidebar-box ftco-animate">
                            <div class="categories">
                                ...
                                <li><a href="<?=base_url()?>profile_like">Cafe yang Disukai</a></li>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="pt-5 mt-5">
							...
							?>
                            <h3 class="mb-5"><?=$likeCafe['count']?> Cafe Yang Disukai</h3>
                            <ul class="comment-list">
                                <?php
								if ($likeCafe['count'])
								{
									foreach ($likeCafe['multi'] as $u)
									{
                                ...
                                <li class="comment">
                                    <div class="vcard bio">
                                        <img src="<?=base_url()?>photo-toko/<?=$dataUser->cover?>"
                    ...
                    <div class="col-md-4">
                        <div class="sidebar-box ftco-animate">
                            ...
                            <div class="block-21 mb-4 d-flex">
                                ...
                                <div class="text">
                                    <h3 class="heading"><a
                                            href="<?=base_url()?>profile-person/<?=$p->username?>"><?=$p->nama?></a>
                                    </h3>
                                    <div class="meta">
                                        <?php
                                        ...
                                        <div><a href="javascript:void(0)" ">Telah Mengikuti</a></div>
															...
															{
																		?>
																<div><a href=" javascript:void(0)" class="folow" data="<?=$p->username?>"><span
                                                    class="material-icons">person_add</span> </a></div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="pengikut">
    <div class="modal-dialog" role="dialog">
        <div class="modal-content bg-primary">
            <div class="modal-header">
                <h4>Pengikut</h4>
            ...
            <div class="modal-body">
                <?php
					$u3 = $user->username;
					$pengikut = crud_selwhere("follower",NULL,"mengikuti = '$u3'");
					if($pengikut['count'] > 0){
						foreach($pengikut['multi'] as $pe){
							$u5 = $pe->username;
							$nama = crud_selwhere("user",NULL,"username = '$u5'")['single']->nama;
							?>
                <div class="row">
                    <div class="col-md-2">
                        <img src="<?=base_url()?>assets/images/user.jpg" alt="Image placeholder"
                            style="width: 100px; height: 50px; border-radius: 50px;" class="img-fluid mb-4">

                    </div>
                    <div class="col-md-6">
                        <p class="text-white" style="margin-top: 10px"><?=$nama?></p>
                    </div>
                </div>
                <?php
						}
...
<div class="modal fade" tabindex="-1" role="dialog" id="mengikuti">
    <div class="modal-dialog" role="dialog">
        <div class="modal-content bg-primary">
            <div class="modal-header">
                <h4>Pengikut</h4>
            ...
            <div class="modal-body">
				...
				$pengikut = crud_selwhere("follower",NULL,"username = '$u4'");
				if($pengikut['count'] > 0){
				foreach($pengikut['multi'] as $pe){
					$u5 = $pe->mengikuti;
					$nama = crud_selwhere("user",NULL,"username = '$u5'")['single']->nama;
