		...
		<section class="home-slider owl-carousel">
			...
			<?php
				...
				if ($cover['count'])
				{
					...
					{
						?>
						<div class="slider-item" style="background-image: url('<?=base_url()?>photo-toko/<?=$item->cover?>');" data-stellar-background-ratio="0.5">
					...
					<div class="col-md-12">
						<div class="row">
								...
								<div class="text py-4 d-block">
									...
									<h3 class="heading mt-2 text-white font-weight-bold"><a href="#"><?=$cafe['single']->nama?></a></h3>

									<p><?=$cafe['single']->alamat?></p>
									<br>
									<div><a href="#" class="font-weight-bold text-white"><?=$provinsi?> ,<?=$kota?> ,<span class="icon-star"></span> <?=number_format($rating,"1",",",".")?>, <span class="icon-chat"></span> <?=$ulasan['count']?></a></div>
								</div>
							<div class="col-md-7 col-sm-12 text-center ftco-animate">
								<p class="breadcrumbs"><span class="mr-2"><a href="<?=base_url()?>">Home</a></span> <span>Menu</span>
									<span><a href="javascript:void(0)" class="btn btn-primary btn-outline-primary" data-toggle="modal" data-target="#media">Pesan</a></span> <span class="btn btn-outline-primary" data-toggle="modal" data-target="#video">Lihat Video</span></p>
							</div>
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-md-5">
										...
										<img src="<?=base_url()?>assets/images/wa.png" alt=""style="width: 100px; height: 100px; object-fit: cover">
									</div>
									<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-md-4">
										...
										<img src="<?=base_url()?>assets/images/grab.jpg" alt=""style="width: 100px; height: 100px; object-fit: cover">
									</div>
									<div class="col-md-6">
										<p class="text-white" style="margin-top: 30px;"><b><?=$grab?></b></p>
									</div>
								</div>
							</div>
						</div>
